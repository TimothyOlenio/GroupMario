...
// save the area size as defined in Tiled
         ...
         //jay, temp thing for testing flying goomba
...
// manage the enemy movement
     update : function (dt)
     {
         if (this.alive)
         {
             if (this.walkLeft && this.pos.x <= this.startX && this.comeUp && this.pos.y <= this.startY)
             {
                 this.walkLeft = false;
             ...
             else if (!this.walkLeft && this.pos.x >= this.endX && !this.comeUp && this.pos.y >= this.endY)
             {
                 this.walkLeft = true;
                 this.body.force.x = -this.body.maxVel.x;
                 this.comeUp = false;
